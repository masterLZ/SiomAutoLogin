1、使用记事本打开 登录.ps1
2、将$ie.document.getelementbyid("password_name").value="xxxx"中的xxxx替换成自己的登录名
3、将$ie.document.getelementbyid("password_pwd").value="xxxx"中的xxxx替换成自己的密码
4、添加 执行.bat 为计划任务，启动时间为每天的4：01：00
